...
## 지원 절차 
  - FIND-A의 지원을 위해서는 아래의 1. 지원서와 2. 코딩 테스트 풀이를 2024년 7월 13일 23시 59분 이전까지 아래 메일로 접수해야합니다. 코딩 테스트의 정답 여부는 면접 후 의사결정에 참고만 될 뿐 결과에 절대적이지 않으니 편한 마음으로 풀이 부탁드립니다. 
  ...
  코딩 테스트 문제지: [코딩 테스트 문제지 바로가기](https://drive.google.com/drive/u/3/folders/1isPlu8zXt-6J1JHG4smdBR9VzLKfozCa)  
